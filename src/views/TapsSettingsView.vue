<template>
    <div class="container">
        ...
        <form @submit.prevent="save" class="needs-validation" novalidate>
            <div class="row">
                <div class="col-md-6">
                    <BsInputNumber v-model="config.keg_weight1" width="5" min="0.0" max="10.0" step="0.01"
                        label="Tap 1 - Empty keg weight" :unit="config.weight_unit" :disabled="global.disabled" />
                </div>
                <div class="col-md-6">
                    <BsInputNumber v-model="config.keg_weight2" width="5" min="0.0" max="10.0" step="0.01"
                        label="Tap 2 - Empty keg weight" :unit="config.weight_unit" :disabled="global.disabled" />
                </div>
                ...
                <div class="col-md-6">
                    <BsSelect v-model="config.keg_volume1" width="8" :options="kegOptions" label="Tap 1 - Keg volume"
