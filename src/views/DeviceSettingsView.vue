    ...
    <div class="container">
        ...
        <form @submit.prevent="saveSettings" class="needs-validation" novalidate>
            <div class="row">
                ...
                <div class="col-md-6">
                    <BsInputRadio v-model="config.weight_unit" :options="weightOptions" label="Weight Format" width=""
                        :disabled="global.disabled"></BsInputRadio>
                </div>
                <div class="col-md-6">
                    <BsInputRadio v-model="config.volume_unit" :options="volumeOptions" label="Volume Format" width=""
                        :disabled="global.disabled"></BsInputRadio>
                </div>
