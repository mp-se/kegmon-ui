    ...
    fetch(global.baseURL + 'levels', {
        ...
        .then(text => {
            ...
            levels.value.forEach(l => {
                ...
                if (!isNaN(l.keg1))
                    historyKeg1.value.push({ x: d, y: l.keg1 })

                if (!isNaN(l.keg2))
                    historyKeg2.value.push({ x: d, y: l.keg2 })
                ...
                if (!isNaN(l.pour1) && l.pour1 > 0) {
                    ...
                    var vol = new Number( config.volume_unit == 'cl' ? l.pour1*100 : (config.volume_unit == "us-oz" ? volumeCLtoUSOZ(l.pour1*100) : volumeCLtoUKOZ(l.pour1*100) )).toFixed(0) + " " + config.getVolumeUnit
                ...
                if (!isNaN(l.pour2)  && l.pour2 > 0) {
                    ...
                    var vol = new Number( config.volume_unit == 'cl' ? l.pour2*100 : (config.volume_unit == "us-oz" ? volumeCLtoUSOZ(l.pour2*100) : volumeCLtoUKOZ(l.pour2*100) )).toFixed(0) + " " + config.getVolumeUnit
