<template>
    <div class="container">
        ...
        <div class="row" v-if="loaded">
            ...
            <div class="col-md-6">
                <BsInputReadonly v-model="stability.stability_popdev1" label="Scale 1 - Pop dev."></BsInputReadonly>
            </div>
            <div class="col-md-6">
                <BsInputReadonly v-model="stability.stability_popdev2" label="Scale 2 - Pop dev."></BsInputReadonly>
            </div>
            <div class="col-md-6">
                <BsInputReadonly v-model="stability.stability_ubiasdev1" label="Scale 1 - Ubias dev."></BsInputReadonly>
            </div>
            <div class="col-md-6">
                <BsInputReadonly v-model="stability.stability_ubiasdev2" label="Scale 2 - Ubias dev."></BsInputReadonly>
            </div>
            <div class="col-md-6">
                <BsInputReadonly v-model="stability.stability_count1" label="Scale 1 - Count"></BsInputReadonly>
            </div>
            <div class="col-md-6">
                <BsInputReadonly v-model="stability.stability_count2" label="Scale 2 - Count"></BsInputReadonly>
            </div>
        </div>
        ...
        <div class="row gy-2">
            ...
            <div class="col-sm-4">
                <button @click="clearStability()" type="button" class="btn btn-secondary" :disabled="global.disabled">
                    Clear stability
                </button>
            </div>
...
onMounted(() => {
    getStability()
    timer.value = setInterval(() => { getStability() }, 4000)
})
