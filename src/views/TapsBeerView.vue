<template>
    <div class="container">
        ...
        <form @submit.prevent="save" class="needs-validation" novalidate>
            <div class="row">
                <div class="col-md-6">
                    <BsInputText v-model="config.beer_name1" maxlength="20" label="Beer 1 - Name"
                        :disabled="global.disabled" />
                </div>
                <div class="col-md-6">
                    <BsInputText v-model="config.beer_name2" maxlength="20" label="Beer 2 - Name"
                        :disabled="global.disabled" />
                </div>

                <div class="col-md-6">
                    <BsInputNumber v-model="config.beer_fg1" label="Beer 1 - FG" min="0" max="2" step="0.0001" width="5"
                        :disabled="global.disabled" />
                </div>
                <div class="col-md-6">
                    <BsInputNumber v-model="config.beer_fg2" label="Beer 2 - FG" min="0" max="2" step="0.0001" width="5"
                        :disabled="global.disabled" />
                </div>

                <div class="col-md-6">
                    <BsInputNumber v-model="config.beer_ebc1" label="Beer 1 - EBC" min="0" max="100" step="1" width="5"
                        :disabled="global.disabled" />
                </div>
                <div class="col-md-6">
                    <BsInputNumber v-model="config.beer_ebc2" label="Beer 2 - EBC" min="0" max="100" step="1" width="5"
                        :disabled="global.disabled" />
                </div>

                <div class="col-md-6">
                    <BsInputNumber v-model="config.beer_ibu1" label="Beer 1 - IBU" min="0" max="100" step="1" width="5"
                        :disabled="global.disabled" />
                </div>
                <div class="col-md-6">
                    <BsInputNumber v-model="config.beer_ibu2" label="Beer 2 - IBU" min="0" max="100" step="1" width="5"
                        :disabled="global.disabled" />
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <button @click="fetchBrewfather(1)" type="button" class="btn btn-secondary w-2"
                        :disabled="global.disabled">
                ...
                <div class="col-md-6">
                    <button @click="fetchBrewfather(2)" type="button" class="btn btn-secondary w-2"
                        :disabled="global.disabled">
                        <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"
                            :hidden="!global.disabled"></span>
                        &nbsp;Fetch from Brewfather
        ...
        <BsModalSelect v-model="beer" :callback="confirmBeerCallback" message="Select a beer to use for the tap"
            id="beer" title="Select beer" :options="beerOptions" />
...
const fetchBrewfather = (tap) => {
    ...
    fetch('https://api.brewfather.app/v2/batches?status=Completed&include=recipe.name,estimatedFg,estimatedColor,estimatedIbu,measuredAbv&complete=false', {
        method: "GET",
        ...
        .then(json => {
            for (var i = 0; i < json.length; i++) {
                ...
                var beer = { label: json[i].recipe.name, value: json[i].batchNo, abv: abv, ibu: ibu, ebc: ebc, fg: fg }
