  ...
  <div class="modal-dialog">
    <div class="modal-content p-4">
      ...
      <div class="modal-body">
        <BsSelect :disabled="disabled" v-model="result" :options="options">
        </BsSelect>
      </div>
      <div class="modal-footer">
        <button :disabled="disabled" @click="callback(true, result)" type="button" class="btn btn-primary" data-bs-dismiss="modal">Confirm</button>
        <button @click="callback(false, '')" type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
      </div>
    </div>
  </div>
</div>
